...
MAX_ANGULAR_VELOCITY = 0.5 * converter_kmh_ms # m/s
...
# BATTERY
BATTERY_DISCHARGE_STATE_IDLE = 100
BATTERY_DISCHARGE_STATE_TRAVEL = 2*350
BATTERY_DISCHARGE_STATE_WORK_SCAN = 1*100
BATTERY_DISCHARGE_STATE_WORK_PROCESS = 2*100
BATTERY_CHARGE_STATE_CHARGING = 10000
